...
W = [ -(L2*(cos(2*q4 - q5) + cos(2*q3 - 2*q4 + q5)))/(4*sin(q4 - q5)), -(L3*(cos(2*q3 - q4) + cos(q4)))/(4*sin(q4 - q5))
 -(L2*(sin(2*q4 - q5) + sin(2*q3 - 2*q4 + q5)))/(4*sin(q4 - q5)), -(L3*(sin(2*q3 - q4) + sin(q4)))/(4*sin(q4 - q5))
                      (L2*sin(q3 - 2*q4 + q5))/(L1*sin(q4 - q5)),               (L3*sin(q3 - q4))/(L1*sin(q4 - q5))
                                                               1,                                                 0
                                                               0,                                                 1];
dq = W*[dq4;dq5];
